...
import test.sushant.batch.EncryptProcessor;
...
public class BatchConfig {
    ...
    @Bean
    public JobExecution jobExecution( FlatFileItemReader reader, EncryptProcessor processor, FlatFileItemWriter writer) throws MalformedURLException {
        ...
        Step step1 = steps.get("step1").<String, String>chunk(1)
                .reader(reader)
                .processor(processor)
                .writer(writer)
